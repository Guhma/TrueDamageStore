...
<main role="main">
  ...
  <div class="album py-2 bg-light">
    <div class="container">
    <p><u><h2 class="text-center">Akali True Damage</u></h2></p>
  <hr>
      <img class="img-fluid" src="img/Akali_13.jpg">
 <hr>
     <div class="text-justify">
      <p id="descricao"> Akali é uma rapper sul-coreana, parte do grupo de k-pop 'K/DA', que, durante o tempo de descanso do grupo, resolveu juntar grandes talentos da indústria musical internacional num grupo que iria quebrar todas as paradas musicais, o True Damage.</p> 
  <hr>
      <div class="text-center">
      <h4>Demonstração:</h4>
      <iframe src="https://www.youtube.com/embed/xoDApmyVDAk?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div class="text-center">
      <hr id="inv">
        <p>
      <a id="compra" href="CompraAkali.php" class="btn btn-dark">Comprar (1350 RP)</a>
    </p>
    </div>
    </div>
