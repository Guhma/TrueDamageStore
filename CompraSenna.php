...
<body style="background-repeat: no-repeat; background-size: cover; background-image: url('img/Senna_1.jpg')">
...
<h4 class="text-secondary text-center" style="padding-top:10px; vertical-align: middle;">Comprando: Senna True Damage (R$25)</h4>
<form method="post">
<div class="row">
    <div class="col">
    <label>Nome</label>
