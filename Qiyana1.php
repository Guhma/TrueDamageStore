...
<main role="main">
  ...
  <section class="text-center bg-dark" style="height:auto">
    <div class="container">
      ...
      <p>
        <a href="https://www.youtube.com/watch?v=sVZpHFXcFJw" class="btn btn-secondary my-2">GIANTS</a>
      </p>
    </div>
  </section>
  ...
  <div class="album py-2 bg-light">
    <div class="container">
    <p><u><h2 class="text-center">Qiyana True Damage</u></h2></p>
  <hr>
      <img class="img-fluid" src="img/Qiyana_2.jpg">
 <hr>
     <div class="text-justify">
      <p id="descricao"> Qiyana é uma cantora de origens latinas, que se juntou a Akali e os outros membros do True Damage para criar "GIANTS", o grande hit da banda. Trazendo consigo um som bilíngue, ela dá um toque latino para o hip-hop True Damage que todos conhecem.</p> 
  <hr>
      <div class="text-center">
      <h4>Demonstração:</h4>
      <iframe src="https://www.youtube.com/embed/rQujudRRr0I?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div class="text-center">
      <hr id="inv">
        <p>
      <a id="compra" href="CompraQiyana1.php" class="btn btn-dark">Comprar (1350 RP)</a>
    </p>
    </div>
    </div>
