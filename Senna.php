...
<main role="main">
  ...
  <div class="album py-2 bg-light">
    <div class="container">
    <p><u><h2 class="text-center">Senna True Damage</u></h2></p>
  <hr>
      <img class="img-fluid" src="img/Senna_1.jpg">
 <hr>
     <div class="text-justify">
      <p id="descricao"> Senna ascendeu à fama com sua fantástica extensão vocal e seu estilo icônico. No entanto, quando um nefasto adversário de seu passado a aprisionou em um contrato de gravadora altamente restritivo (que tomou toda sua independência criativa), ela sumiu dos holofotes. Após anos vivendo nas sombras, ela emerge como vocalista principal do True Damage, determinada a definir seu legado sob seus próprios termos.
</p> 
  <hr>
      <div class="text-center">
      <h4>Demonstração:</h4>
      <iframe src="https://www.youtube.com/embed/3cFJPi_iTo0?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div class="text-center">
      <hr id="inv">
        <p>
      <a id="compra" href="CompraSenna.php" class="btn btn-dark">Comprar (1350 RP)</a>
    </p>
    </div>
    </div>
