...
<main role="main">
  ...
  <div class="album py-2 bg-light">
    <div class="container">
    <p><u><h2 class="text-center">Qiyana True Damage Edição de Prestígio</u></h2></p>
  <hr>
      <img class="img-fluid" src="img/Qiyana2.jpg">
 <hr>
     <div class="text-justify">
      <p id="descricao"> Sempre no centro dos holofotes, Qiyana se vestiu para causar no show do True Damage em Paris, com todos os ingressos esgotados, obviamente. Enquanto os paparazzi a rodeavam com fotos e entrevistas, ela se deleitava com a atenção, sabendo que aquilo era só o começo de seu império como celebridade.</p> 
  <hr>
      <div class="text-center">
      <h4>Demonstração:</h4>
      <iframe src="https://www.youtube.com/embed/4ZGRjQqLiNo?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div class="text-center">
      <hr id="inv">
        <p>
      <a id="compra" href="CompraQiyana2.php" class="btn btn-dark">Comprar (2000 Emblemas do Mundial)</a>
    </p>
    </div>
    </div>
