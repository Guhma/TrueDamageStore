...
<main role="main">
  ...
  <div class="album py-2 bg-light">
    <div class="container">
    <p><u><h2 class="text-center">Ekko True Damage</u></h2></p>
  <hr>
      <img class="img-fluid" src="img/Ekko_4.jpg">
 <hr>
     <div class="text-justify">
      <p id="descricao"> Ekko é um rapper americano que se juntou ao grupo formado por Akali e foi escolhido como "protagonista" da sua música, "GIANTS". Seu rap é incrivelmente rápido e ele é conhecido por poder voltar no tempo... literalmente.</p> 
  <hr>
      <div class="text-center">
      <h4>Demonstração:</h4>
      <iframe src="https://www.youtube.com/embed/lGXYssZ63BU?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div class="text-center">
      <hr id="inv">
        <p>
      <a id="compra" href="CompraEkko.php" class="btn btn-dark">Comprar (1350 RP)</a>
    </p>
    </div>
    </div>
