...
<body style="background-repeat: no-repeat; background-size: cover; background-image: url('img/Akali_13.jpg')">
...
<h4 class="text-secondary text-center" style="padding-top:10px; vertical-align: middle;">Comprando: Akali True Damage (R$25)</h4>
<form method="post">
<div class="row">
    <div class="col">
    <label>Nome</label>
